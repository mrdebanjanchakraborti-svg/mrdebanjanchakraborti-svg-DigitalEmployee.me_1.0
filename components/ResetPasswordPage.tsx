    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#020617] relative overflow-hidden">
      ...
      <div className="w-full max-w-lg animate-fade-in">
        <div className="glass-card rounded-[3rem] border-white/5 shadow-2xl overflow-hidden relative">
          <div className="absolute top-0 right-0 p-12 opacity-[0.03] text-9xl font-black">KEY</div>
          ...
          <div className="p-10 lg:p-14 relative z-10">
            {success ? (
              <div className="text-center py-10 animate-fade-in">
                ...
                <p className="text-slate-500 mb-12 font-medium">Your secret key has been successfully updated across all neural nodes.</p>
                <button 
                  onClick={() => onNavigate('home')}
                  className="w-full bg-white text-slate-950 py-5 rounded-2xl font-black uppercase tracking-widest text-xs transition-all hover:bg-emerald-500 hover:text-white shadow-xl"
                >
                  Return to Console
                </button>
              </div>
              ...
              <>
                <div className="text-center mb-12">
                  ...
                  <h2 className="text-4xl font-black text-white mb-2 uppercase tracking-tighter">Reset Neural Key</h2>
                  <p className="text-slate-500 font-medium">Update your system access credentials</p>
                </div>

                <form onSubmit={handleReset} className="space-y-6">
                  <div>
                    <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-3 ml-1">New Secret Key (Password)</label>
                    <input 
                      required
                      type="password" 
                      value={password}
                      ...
                      placeholder="••••••••" 
                      className="w-full bg-slate-900 border border-white/10 rounded-2xl px-6 py-5 text-white focus:outline-none focus:border-red-500 transition-all font-medium"
                    />
                  ...
                  <div>
                    <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-3 ml-1">Verify Key</label>
                    <input 
                      required
                      type="password" 
